...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 p-4 overflow-hidden relative">
      ...
      <Card className="w-full bg-gradient-to-br from-gray-900 via-black to-blue-900/50 backdrop-blur-lg border-white/20 shadow-2xl shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-500 transform hover:-translate-y-1 relative overflow-hidden">
  ...
  <div className="relative z-10">
    <CardHeader className="space-y-1 pb-6">
      <div className="flex justify-center mb-4">
        <div className="relative">
          <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/30 relative overflow-hidden">
      ...
      <CardTitle className="text-3xl font-bold text-center bg-gradient-to-r from-blue-300 via-cyan-300 to-blue-400 bg-clip-text text-transparent">
    ...
    <CardContent>
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <div className="relative">
              <Input
                ...
                required
                disabled={isLoading}
                className="bg-gradient-to-r from-gray-900/50 to-black/50 backdrop-blur-sm border-gray-700/50 focus:border-blue-400/50 focus:ring-2 focus:ring-blue-400/30 pl-10 py-6 text-white placeholder:text-gray-400 transition-all duration-300 hover:from-gray-800/50 hover:to-black/50"
              />
        ...
        <Button 
          type="submit" 
          className="w-full py-6 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 hover:from-blue-700 hover:via-blue-600 hover:to-cyan-600 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group"
          disabled={isLoading}
        ...
        {process.env.NODE_ENV === "development" && (
          <div className="mt-6 p-4 bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm rounded-xl space-y-3 text-sm border border-gray-800/30">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                disabled={isLoading}
                className="bg-gradient-to-r from-gray-900/30 to-black/30 backdrop-blur-sm border-gray-700/50 hover:border-blue-400/50 hover:from-blue-900/20 hover:to-black/20 text-gray-300 transition-all duration-300"
              >
                Test User
              </Button>
              <Button
                ...
                disabled={isLoading}
                className="bg-gradient-to-r from-gray-900/30 to-black/30 backdrop-blur-sm border-gray-700/50 hover:border-purple-400/50 hover:from-purple-900/20 hover:to-black/20 text-gray-300 transition-all duration-300"
              >
                Admin User
              </Button>
            </div>
